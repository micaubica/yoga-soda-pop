...
const PRODUCTS=[
  ...
  {name:"K-Pop Demon Hunters Backpack — Pink Anime Girl Band School Bag",price:"$64.99",originalPrice:null,image:"/assets/001.jpg",url:"https://shop.yogasodapop.com/product/k-pop-demon-hunters-backpack-cute-anime-girls-raindrop-school-bag/?v=30fd57ddcc95"},
...
function TopYoutubeIcon(){
 return <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true"><rect x="2" y="5" width="20" height="14" rx="4" fill="white"/><path d="m10 9 6 3-6 3Z" fill="#e96f91"/></svg>;
}
...
export default function Home(){
 ...
 return <main className="ysp-home">
  <div className="ysp-topbar"><a className="ysp-youtube-top" href={YOUTUBE_URL} target="_blank" rel="noreferrer"><TopYoutubeIcon/> WATCH OUR MUSIC ON YOUTUBE →</a><span>FREE WORLDWIDE SHIPPING — WEBSITE ORDERS ONLY</span><span>SECURE CHECKOUT</span><span>EASY RETURNS</span></div>
  <header className="ysp-header"><Link className="ysp-brand" href="/">YOGA SODA POP</Link><nav><a href={SHOP_URL}>SHOP</a><a href="/music">MUSIC</a><a href="/about">ABOUT</a></nav><div className="ysp-header-tools"><a href="https://shop.yogasodapop.com/?s=&post_type=product" aria-label="Search"><UtilityIcon type="search"/></a><a href="https://shop.yogasodapop.com/my-account/" aria-label="Account"><UtilityIcon type="account"/></a><a href="https://shop.yogasodapop.com/cart/" aria-label="Cart"><UtilityIcon type="cart"/></a></div><div className="ysp-header-actions"><a className="ysp-header-cta ysp-shop-link" href={SHOP_URL}><UtilityIcon type="cart"/> SHOP THE DROP →</a><a className="ysp-etsy-cta" href={ETSY_URL} target="_blank" rel="noreferrer"><span>E</span> SHOP ON ETSY →</a></div></header>
  <section className="ysp-collage-hero">
   ...
   <div className="ysp-hero-card"><span>SHOP + MUSIC</span><h1 style={{color:"#111318"}}>K-POP STYLE<br/>FOR EVERY DAY</h1><p>Original K-pop inspired backpacks, merch & music for fans who like to stand out.</p><div className="ysp-hero-buttons"><a className="ysp-shop-link" href={SHOP_URL}><UtilityIcon type="cart"/> SHOP BACKPACKS →</a><a className="ysp-youtube-hero" href={YOUTUBE_URL} target="_blank" rel="noreferrer"><UtilityIcon type="youtube"/> WATCH ON YOUTUBE →</a></div></div>
  </section>
  ...
  <section className="ysp-shop" id="shop-the-drop"><div className="ysp-section-head"><div><span className="ysp-kicker">FRESH PICKS</span><h2>NEW ARRIVALS <em>✦</em></h2></div><a className="ysp-shop-link" href={SHOP_URL}><UtilityIcon type="cart"/> VIEW ALL →</a></div><div className="ysp-products">{PRODUCTS.map((p,index)=><article className="ysp-card" key={p.url}><a className="ysp-card-image" href={p.url}>{index===0&&<span className="ysp-trending">TRENDING</span>}<span className="ysp-heart">♡</span><img src={p.image} alt={p.name} width="480" height="480" loading="lazy"/></a><div className="ysp-card-body"><h3>{index===0?"Chibi Anime Backpack":index===1?"Pink Anime Backpack":"Cute Kawaii Print Backpack"}</h3><div className="ysp-price"><strong>{p.price}</strong>{p.originalPrice&&<del>{p.originalPrice}</del>}</div><span className="ysp-free-shipping">Free shipping on our website</span><a className="ysp-buy ysp-shop-link" href={p.url}><UtilityIcon type="cart"/> SHOP BACKPACK →</a></div></article>)}</div></section>
  <section className="ysp-feature-row"><div className="ysp-more-card"><div className="ysp-more-art"><img src="/assets/hero-shoes.png" alt="Yoga Soda Pop street style"/></div><div className="ysp-more-copy"><span>DISCOVER MORE</span><h2>EXPLORE THE WORLD OF<br/>YOGA SODA POP</h2><p>Accessories, art, music and more — all in one place.</p><a className="ysp-shop-link" href={SHOP_URL}><UtilityIcon type="cart"/> EXPLORE COLLECTION →</a></div></div><div className="ysp-music-card"><div className="ysp-music-copy"><span>YOGA SODA POP BEATS</span><h2>MUSIC FOR<br/>ANOTHER WORLD</h2><p>Original beats, animated stories and bright pop energy.</p><div><a href={YOUTUBE_URL} target="_blank" rel="noreferrer"><UtilityIcon type="youtube"/> MORE ON YOUTUBE →</a></div></div><div className="ysp-music-image"><iframe width="560" height="315" src="https://www.youtube.com/embed/fr1hD_pc9tw?si=skESmYSR44jgk9ky" title="Yoga Soda Pop featured YouTube video" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe></div></div></section>
  ...
  <footer className="ysp-footer"><b>YOGA SODA POP</b><nav><a href={SHOP_URL}>SHOP</a><a href="/music">MUSIC</a><a href="/about">ABOUT</a><a href="/shipping-returns">SHIPPING</a><a href="/contact">CONTACT</a><a href={ETSY_URL} target="_blank" rel="noreferrer">ETSY</a></nav><div><a className="ysp-footer-youtube" href={YOUTUBE_URL} target="_blank" rel="noreferrer" aria-label="Yoga Soda Pop Beats on YouTube"><UtilityIcon type="youtube"/></a><a href={INSTAGRAM_URL} target="_blank" rel="noreferrer" aria-label="Yoga Soda Pop on Instagram"><UtilityIcon type="instagram"/></a><a href={SPOTIFY_URL} target="_blank" rel="noreferrer" aria-label="Yoga Soda Pop on Spotify"><UtilityIcon type="spotify"/></a></div><small>© 2026 Yoga Soda Pop · Gamers4Gamers, LLC.</small></footer>
 </main>;
}
